...
class CreatePelaksanaanItemAsmenPengawasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('item_asmen_pengawas', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('item_asmen_pengawas');
    }
}
