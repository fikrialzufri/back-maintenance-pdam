                                        ...
                                        @if ($dirut->jabatan === 'Direktur Utama')
                                            ...
                                            @if ($dirut)
                                                @if ($dirut->url)
                                                    ...
                                                    {!! QrCode::size(100)->merge('https://pdam.borneocorner.com/img/logo-pdam.png')->generate($dirut->url) !!}
                                                @else
                                                    @if ($dirut->tdd)
                                                        {{-- <img src="data:image/png;base64, {!! base64_encode(
                                                        ...
                                                        {!! QrCode::size(100)->merge('https://pdam.borneocorner.com/img/logo-pdam.png')->generate(url('tddkaryawan/' . $dirut->id)) !!}
                                                    @endif
                                                @endif
                                            @endif
                                        @endif
