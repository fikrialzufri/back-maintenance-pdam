                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="text" placeholder="Kode Anggaran 31.05.30"
                                                            class="form-control" readonly
                                                            value="{{ $tagihan->anggaran_satu }} = Rp.{{ format_uang($tagihan->total_anggaran_satu) }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div>
                                                    ...
                                                    <div>
                                                        <input type="text" placeholder="Kode Anggaran 93.02.30"
                                                            class="form-control" readonly
                                                            value="{{ $tagihan->anggaran_dua }} = Rp.{{ format_uang($tagihan->total_anggaran_dua) }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div>
                                    ...
                                    <div class="input-group input-group-button">
                                        <div class="input-group-prepend">
                                            <a class="btn btn-primary"
                                                href="{{ $tagihan->no_kwitansi_image != '' ? asset('storage/tagihan/' . $tagihan->no_kwitansi_image) : route('abort') }}"
                                                target="_blank">
