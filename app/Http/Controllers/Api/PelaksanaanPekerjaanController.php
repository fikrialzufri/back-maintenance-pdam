...
class PelaksanaanPekerjaanController extends Controller
{
    ...
    public function selesai(Request $request)
    {
        DB::beginTransaction();
        // list jabatan
        $listJabatan = Jabatan::whereSlug('manajer-distribusi')->orWhere('slug', 'manajer-perencanaan')->orWhere('slug', 'asisten-manajer-perencanaan')->orWhere('slug', 'direktur-teknik')->get()->pluck('id')->toArray();
